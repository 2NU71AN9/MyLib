...
class SLPhotoViewController: SLPhotoBaseViewController {
            ...
            DispatchQueue.global().async {
                ...
                DispatchQueue.main.async {
                    ...
                    if self.photos.count > 0 {
                        //self.collectionView.scrollToItem(at: IndexPath(row: self.photos.count - 1, section: 0), at: .bottom, animated: false)
                    } else {
    ...
    override func viewDidLayoutSubviews() {
        ...
        collectionView.frame = CGRect(x: 0, y: 0, width: view.bounds.width, height: view.bounds.height - tabBarHeight)
        buttomView.frame = CGRect(x: 0, y: view.bounds.height - tabBarHeight, width: view.bounds.width, height: tabBarHeight)
    }
    ...
    fileprivate var buttomView: SLButtomView = {
        ...
        buttonView.backgroundColor = #colorLiteral(red: 0.921431005, green: 0.9214526415, blue: 0.9214410186, alpha: 1)
        return buttonView
    }()
}
